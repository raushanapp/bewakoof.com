      ...
      <div className="wholeprice-box">
        <div className="redeem-box">
          <div className="inside-redeem">
            <input
              ...
              name="couponCode"
            />
            <button className="redeem-btn" onClick={handleClick}>Redeem</button>
          </div>
        </div>
        ...
        <div className="total-price">
          ...
          <div className="pricedes-box">
            <div className="inside-pdb">
              ...
              <div className="actual-price">{`₹ ${strikedPrice}`}</div>
            </div>
          </div>
          <div className="pricedes-box">
            <div className="inside-pdb">
          ...
          <div className="pricedes-box">
            <div className="inside-pdb">
              ...
              <div className="actual-price">{`-₹ ${Math.abs(strikedPrice-actualPrice)}`}</div>
            </div>
          </div>
          <div className="pricedes-box">
            <div className="inside-pdb">
          ...
          <div className="saving">
            <div className="inside-saving">{`You are saving ₹ ${Math.abs(strikedPrice-actualPrice)} on this order`}</div>
          </div>
        </div>
        <div className="proceed-payment">
          <div className="inside-pp">
            ...
            <button className="p-to-p-btn" onClick={Proceed}>Proceed to Payment</button>
          </div>
        </div>
      </div>
    </div>
...
// const [menenter,setMenenter]=usstate(true)
// const [womenenter,setenenter]=usstate(true)
// const [accenter,setMenenter]=usstate(true)
// const handlemenenter=()=>{
//  setMenenter(true)
//  setwomenenter(false)
//  setwomenenter(false)
// }

// const handlemenleave=()=>{
//     setMenenter(false)
//     setwomenenter(false)
//     setwomenenter(false)
// }
